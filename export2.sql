...
SET DEFINE OFF;
Insert into HR.JUGADORES (JUGADORES_ID,EDAD,ALTURA,DORSAL,EQUIPO_ID,NOMBREJUGADOR) values ('1','25','172','17','1','LUCAS');
Insert into HR.JUGADORES (JUGADORES_ID,EDAD,ALTURA,DORSAL,EQUIPO_ID,NOMBREJUGADOR) values ('2','28','170','12','1','MARCELO');
Insert into HR.JUGADORES (JUGADORES_ID,EDAD,ALTURA,DORSAL,EQUIPO_ID,NOMBREJUGADOR) values ('3','20','180','20','1','ASENSIO');
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."CANTICOS" ADD CONSTRAINT "AFICION_ID" FOREIGN KEY ("AFICION_ID")
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."EQUIPO" ADD CONSTRAINT "ESTADIO_ID" FOREIGN KEY ("ESTADIO_ID")
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."JUGADORES" ADD CONSTRAINT "EQUIPO_ID" FOREIGN KEY ("EQUIPO_ID")
	  REFERENCES "HR"."EQUIPO" ("EQUIPO_ID") ENABLE;
--------------------------------------------------------
